        ...
        <div>
            <div>
                <h5 style="font-size: 30px;font-weight:bolder; text-transform:uppercase;margin-top: 0px;margin-bottom: 0px">
                    EasyData Airtime To Wallet Transaction</h5>
                ...
                <table>
                    ...
                    <tr>
                        <td>Reference:</td>
                        <td>{{$airtimeToWalletTransaction->reference}}</td>
                    </tr>
                    <tr>
                        <td>Beneficiary:</td>
                        <td>{{$airtimeToWalletTransaction->recipient_phone}}</td>
                    </tr>
                    <tr>
                        <td>Amount:</td>
                        <td>{{$airtimeToWalletTransaction->amount}}</td>
                    </tr>
                    </tbody>
                </table>
