        ...
        <div>
            <div>
                <h5 style="font-size: 30px;font-weight:bolder; text-transform:uppercase;margin-top: 0px;margin-bottom: 0px">
                    EasyData Bitcoin Transaction</h5>
                ...
                <table>
                    ...
                    <tr>
                        <td>Reference:</td>
                        <td>{{$bitcoinTransaction->reference}}</td>
                    </tr>
                    <tr>
                        <td>Amount Sold:</td>
                        <td>{{$bitcoinTransaction->amount_to_sell}}</td>
                    </tr>
                    <tr>
                        <td>Amount To Receive:</td>
                        <td>{{$bitcoinTransaction->amount_to_receive}}</td>
                    </tr>
                    <tr>
                        <td>Buying rate of:</td>
                        <td>{{$bitcoinTransaction->buying_rate}}</td>
                    </tr>
                    </tbody>
                </table>
