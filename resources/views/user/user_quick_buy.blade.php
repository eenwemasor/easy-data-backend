        ...
        <div>
            <div>
                <h5 style="font-size: 30px;font-weight:bolder; text-transform:uppercase;margin-top: 0px;margin-bottom: 0px">
                    EasyData Transaction</h5>
                <hr style="margin-bottom: 60px"/>
                <p>Thank you for Buying with easy-data communication; Below isa summary of your transaction. feel free to
                    send a mail if you have a any complain or request </p>
                <table>
                    <tbody>
                    <tr>
