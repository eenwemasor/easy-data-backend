        ...
        <div>
            <div>
                <h5 style="font-size: 30px;font-weight:bolder; text-transform:uppercase;margin-top: 0px;margin-bottom: 0px">
                    EasyData Airtime To Cash Transaction</h5>
                ...
                <table>
                    ...
                    <tr>
                        <td>Reference:</td>
                        <td>{{$airtimeToCashTransaction->reference}}</td>
                    </tr>
                    <tr>
                        <td>Beneficiary:</td>
                        <td>{{$airtimeToCashTransaction->recipient_phone}}</td>
                    </tr>
                    <tr>
                        <td>Amount:</td>
                        <td>{{$airtimeToCashTransaction->amount}}</td>
                    </tr>
                    </tbody>
                </table>
