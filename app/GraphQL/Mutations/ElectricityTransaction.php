...
use App\Services\ElectricityTransactionService;
...
{
    /**
     * @var ElectricityTransactionService
     */
    private $electricity_transaction;

    /**
     * ElectricityTransactionEvent constructor.
     * @param ElectricityTransactionService $electricity_transaction_service
     */
    public function __construct(ElectricityTransactionService $electricity_transaction_service)
    {
        $this->electricity_transaction = $electricity_transaction_service;
    }
    /**
