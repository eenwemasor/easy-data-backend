...
class GiftcardTransaction
{
    ...
    {
        return $this->giftcard_transaction_service->mark_transaction_successful($args['transaction_id']);
    ...
    {
        return $this->giftcard_transaction_service->mark_transaction_failed($args['transaction_id']);
